...
<div class="form-group row d-flex justify-content-end">
	<div class="col-12 text-center text-lg-right">
		{!! Form::button('<i class="fas fa-lock-open-alt mr-2"></i>ABIERTO', ['class'=>'btn btn-success px-5', 'type' => 'button', 'id' => 'boton_estado', 'value' => 'ABIERTO']) !!}
		{!! Form::hidden('btn_estado', isset($coordinacion) ? $coordinacion->estado : '', ['id' => 'recibir_estado']) !!}
	</div>
</div>
...
<div class="form-group row mb-0">
	...
	<div class="col-12 col-md-6 col-lg-6 mt-2 px-md-2{{ $errors->has('nom_equipo') ? ' has-error-select2' : ''}}" >
		...
		{!! Form::select('nom_equipo', ['' => 'SELECCIONAR...'] + $equipo, isset($coordinacion) ? $coordinacion->equipos_id : '', ['class' => 'form-control form-control-sm', 'onpaste' => 'return false', 'autocomplete' => 'off', 'id' => 'nom_equipo']) !!}
	...
	<div class="col-12 col-md-6 col-lg-6 mt-2 d-flex justify-content-center mt-4 mt-md-0">
					...
					<div class="col-12">
						...
						<div class="form-group row">
							...
							<div class="col-12 col-lg-9 col-xl-10 pl-lg-0{{ $errors->has('local') ? ' has-error-select2' : ''}}">
								{!! Form::select('local', $local , isset($coordinacion) ? $coordinacion->locales_id : '', ['class' => 'form-control form-control-sm', 'id' => 'local']) !!}
						...
						<div class="form-group row">
							...
							<div class="col-12 col-lg-9 col-xl-10 pl-lg-0{{ $errors->has('area') ? ' has-error-select2' : ''}}">
								{!! Form::select('area', $area, isset($coordinacion) ? $coordinacion->areas_id : '', ['class' => 'form-control form-control-sm', 'id' => 'area', 'data-old' => $coordinacion->areas_id]) !!}
						...
						<div class="form-group row">
							...
							<div class="col-12 col-lg-9 col-xl-10 pl-lg-0{{ $errors->has('oficina') ? ' has-error-select2' : ''}}">
								{!! Form::select('oficina', $oficina, null, ['class' => 'form-control form-control-sm', 'id' => 'oficina', 'data-old' => $coordinacion->oficinas_id]) !!}	
	...
	<div class="col-12 col-md-6 col-lg-6 mt-2 px-md-2">
		<div class="card mb-3 border-success">
			<div class="card-header text-white font-weight-bold bg-success" data-toggle="collapse" data-target="#entrega">Entrega de Folios
				<a class="float-right" data-toggle="collapse" data-target="#entrega" class="collapsed" title="Acoplar">
					<em class="fa fa-plus"></em>
				</a>
			</div>
						...
						<div class="form-group row">
							...
							<div class="col-12 col-lg-7 pl-lg-0">
								<div class="input-group{{ $errors->has('fec_ent') ? ' has-error' : ''}}">
									{!! Form::text('fec_ent', isset($coordinacion) ? date('d-m-Y', strtotime($coordinacion->fec_ent)) : '', ['class' => 'form-control form-control-sm datepicker' , 'id' => 'fec_ent', 'autocomplete' => 'off', 'readonly', 'placeholder' => 'DD-MM-YYYY']) !!}
									{!! Form::hidden('fec_ent_hide', null, ['id' => 'fec_ent_hide']) !!}
									<div class="input-group-append">
	...
	<div class="col-12 col-md-6 col-lg-6 mt-2 px-md-2">
		<div class="card mb-3 border-danger">
			<div class="card-header text-white font-weight-bold bg-danger" data-toggle="collapse" data-target="#retorno">Retorno de Folios
				<a class="float-right" data-toggle="collapse" data-target="#retorno" class="collapsed">
					<em class="fa fa-plus"></em>
				</a>
			</div>
			<div class="collapse show" id="retorno" style="">
				<div class="card-body row">
					<div class="col-12">
						...
						<div class="form-group row">
							...
							<div class="col-12 col-lg-7 pl-lg-0">
								<div class="input-group{{ $errors->has('fec_ret') ? ' has-error' : ''}}">
									{!! Form::text('fec_ret', ($coordinacion->fec_ret === NULL) ? '' : date('d-m-Y', strtotime($coordinacion->fec_ret)), ['class' => 'form-control form-control-sm datepicker' , 'id' => 'fec_ret', 'autocomplete' => 'off', 'readonly', 'placeholder' => 'DD-MM-YYYY']) !!}
									<div class="input-group-append">
										<span class="input-group-text"><i class="fal fa-calendar-alt"></i>
										</span>
									</div>
	...
	<div class="col-12 col-md-6 col-lg-6 mt-2 px-md-2">
		<div class="card mb-3 border-info">
			<div class="card-header font-weight-bold text-white bg-info" data-toggle="collapse" data-target="#final">Control Final
				<a class="float-right" data-toggle="collapse" data-target="#final" class="collapsed">
					<em class="fa fa-plus"></em>
				</a>
			</div>
			<div class="collapse show" id="final" style="">
				<div class="card-body row">
					<div class="col-12">
