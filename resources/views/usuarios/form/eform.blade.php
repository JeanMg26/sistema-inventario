      ...
      <div class="row d-flex justify-content-center">
         <div class="col-12 col-md-11 col-lg-10">
            ...
            <div class="text-center mt-2">
               {!! Html::decode(Form::label('miImagenInput', '<i class="fas fa-cloud-upload-alt"></i> Subir Imagen', ['class' => 'btn btn-info btn-sm py-1', 'style' => 'cursor:pointer'])) !!}
   ...
   <div class="col-12 col-md-12 col-lg-9">
      <div class="row">
         <div class="col-12 col-sm-6 col-lg-6 mt-2 px-sm-2{{ $errors->has('nom_usu') ? ' has-error' : ''}}">
            ...
            {!! Form::text('nom_usu', isset($usuario) ? $usuario->name : '', ['class' => 'form-control form-control-sm ' , 'placeholder' => 'Nombre de Usuario', 'autocomplete' => 'off', 'autofocus', 'id' => 'nom_usuario']) !!}
         ...
         <div class="col-12 col-sm-6 col-lg-6 mt-2 px-sm-2{{ $errors->has('rol_usu') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::select('rol_usu', ['' => 'SELECCIONAR...'] + $rol, $usuarioRol, ['class' => 'form-control form-control-sm', 'autocomplete' => 'off', 'id' => 'rol']) !!}
         ...
         <div class="col-12 col-sm-8 col-lg-8 mt-2 px-sm-2">
            ...
            <div class="input-group{{ $errors->has('email_usu') ? ' has-error' : ''}}">
               {!! Form::text('email_usu', isset($usuario) ? $usuario->email : '', ['class' => 'form-control form-control-sm ', 'placeholder' => 'ejemplo@email.com',  'onpaste' => 'return false', 'autocomplete' => 'off', 'id' => 'email_usuario']) !!}
            ...
            <div class="card border-secondary">
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-12 col-sm-6 col-lg-6">
                        {!! Html::decode(Form::label('recontraseña', 'Repetir Contraseña <span class="text-danger font-weight-normal h6 ml-1">*</span>', ['class' => 'font-weight-bold'])) !!}
                        <div class="input-group{{ $errors->has('repass_usu') ? ' has-error' : ''}}">
                           {!! Form::password('repass_usu', ['class' => 'form-control form-control-sm ' , 'placeholder' => 'Contraseña', 'onpaste' => 'return false', 'autocomplete' => 'off', 'id' => 'repassword_usu']) !!}
                           <div class="input-group-append">
